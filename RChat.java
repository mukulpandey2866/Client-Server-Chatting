...
import javax.swing.event.*;                    //      importing java swing event components
import java.io.*;
import java.net.*;
 ...
 // GUI class Hotel for Application
    
public class RChat extends JFrame implements ActionListener,Runnable
...
RChat()                              // Invoking Constructor
   
    {     
          
          frame = new JFrame("Receive Messages");
        ...
        while(true)
         {
           ...
           }catch(Exception e){ System.out.println("Input Stream Error");}
         }
...
{       
     ...
     try{
      ...
      } catch (Exception e) { System.out.println("Exception in Sending Message");
 ...
 public static void main(String args[])     // main method to perform operation
   
    {
                        ...
                        RChat H= new RChat();    // creating an object for hotel class      
